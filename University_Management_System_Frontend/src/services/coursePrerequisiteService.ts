...
const coursePrerequisiteService = {
  ...
  replacePrerequisites: async (
    ...
    const existingPrereqs =
      await coursePrerequisiteService.getPrerequisites(courseId);
  ...
  replaceDependencies: async (
    ...
    const existingDeps =
      await coursePrerequisiteService.getDependencies(prerequisiteCourseId);
    ...
    for (const id of existingIds) {
      await coursePrerequisiteService.removeDependency(
        prerequisiteCourseId,
        id
      );
    }
