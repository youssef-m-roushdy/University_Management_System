...
{
    public class CourseFilterInSpecailizationQueriesValidator : AbstractValidator<CourseFilterInSpecailizationQueries>
    {
        public CourseFilterInSpecailizationQueriesValidator()
        {
