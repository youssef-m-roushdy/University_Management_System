...
{
    public class AcademicScheduleSemesterQueriesValidator : AbstractValidator<AcademicScheduleSemesterQueries>
    {
        public AcademicScheduleSemesterQueriesValidator()
        {
