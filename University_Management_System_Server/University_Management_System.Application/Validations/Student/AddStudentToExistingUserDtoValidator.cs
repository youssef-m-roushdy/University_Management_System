...
{
    public class AddStudentToExistingUserDtoValidator : AbstractValidator<AddStudentToExistingUserDto>
    {
        public AddStudentToExistingUserDtoValidator()
        {
            // ─── User Email ────────────────────────────────────────────────────
            ...
            RuleFor(x => x.Level)
                ...
                .Must(level => level != Levels.Graduate).WithMessage("Cannot add student with Graduate level");
