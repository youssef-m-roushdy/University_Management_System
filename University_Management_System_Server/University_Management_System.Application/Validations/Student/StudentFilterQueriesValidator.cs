...
{
    public class StudentFilterQueriesValidator : AbstractValidator<StudentFilterQueries>
    {
        public StudentFilterQueriesValidator()
        {
            ...
            RuleFor(x => x.DepartmentSearch)
                .MaximumLength(100).WithMessage("Department search term must not exceed 100 characters")
