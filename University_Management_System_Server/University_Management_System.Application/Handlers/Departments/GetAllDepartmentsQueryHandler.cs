...
{
    public class GetAllDepartmentsQueryHandler : IRequestHandler<GetAllDepartmentsQuery, ApiResponse<IEnumerable<DepartmentDto>>>
    {
        ...
        public async Task<ApiResponse<IEnumerable<DepartmentDto>>> Handle(GetAllDepartmentsQuery request, CancellationToken cancellationToken)
        {
            ...
            return ApiResponse<IEnumerable<DepartmentDto>>.SuccessResponse(result);
        }
    }
}
