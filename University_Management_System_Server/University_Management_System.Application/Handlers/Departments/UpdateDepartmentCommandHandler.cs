...
{
    public class UpdateDepartmentCommandHandler : IRequestHandler<UpdateDeparmentCommand, ApiResponse<DepartmentDto>>
    {
        ...
        public async Task<ApiResponse<DepartmentDto>> Handle(UpdateDeparmentCommand request, CancellationToken cancellationToken)
        {
