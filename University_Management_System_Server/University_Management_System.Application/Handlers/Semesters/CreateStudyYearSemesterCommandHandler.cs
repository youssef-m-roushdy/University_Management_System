...
{
    public class CreateStudyYearSemesterCommandHandler : IRequestHandler<CreateStudyYearSemesterCommand, SemesterDto>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public CreateStudyYearSemesterCommandHandler(IUnitOfWork unitOfWork, IMapper mapper)
        {
            _unitOfWork = unitOfWork;
            _mapper = mapper;
        }

        public async Task<SemesterDto> Handle(CreateStudyYearSemesterCommand request, CancellationToken cancellationToken)
        {
