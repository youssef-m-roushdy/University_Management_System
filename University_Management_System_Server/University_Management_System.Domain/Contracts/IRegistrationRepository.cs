...
namespace University_Management_System.Domain.Contracts
{
    ...
    {
        // ─── Get by student ────────────────────────────────────────────────────
        Task<(IEnumerable<Registration> Data, int TotalCount)> GetByStudentIdAsync(
            string studentId,
            RegistrationFilterQueries? filter = null,
            CancellationToken cancellationToken = default);
        
        Task<(IEnumerable<Registration> Data, int TotalCount)> GetByStudentAndStudyYearAsync(
            string studentId,
            int studyYearId,
            RegistrationStudyYearQueries? filter = null,
            CancellationToken cancellationToken = default);
        
        Task<(IEnumerable<Registration> Data, int TotalCount)> GetByStudentAndStudyYearAndSemesterAsync(
            string studentId,
            int studyYearId,
            int semesterId,
        ...
        Task<Registration?> GetByStudentAndCourseAsync(
            string studentId,
            int courseId,
            int studyYearId);
        
        // ─── Get by course ────────────────────────────────────────────────────
        Task<(IEnumerable<Registration> Data, int TotalCount)> GetByCourseIdAsync(
            int courseId,
            RegistrationFilterQueries? filter = null,
            CancellationToken cancellationToken = default);
        
        // ─── Get by semester ──────────────────────────────────────────────────
        Task<(IEnumerable<Registration> Data, int TotalCount)> GetBySemesterIdAsync(
            int semesterId,
            RegistrationSemesterQueries? filter = null,
            CancellationToken cancellationToken = default);
        ...
        Task<(IEnumerable<Registration> Data, int TotalCount)> GetAllFilteredAsync(
            RegistrationFilterQueries? filter = null,
            CancellationToken cancellationToken = default);
